...
public class EmployeeSequenceGenerator implements IdentifierGenerator {

	private static final int INITIAL_VALUE = 1111;
	private static final String name = "employee_sequence_generator";
